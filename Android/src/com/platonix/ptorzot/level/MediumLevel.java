...
public class MediumLevel extends GameLevel 
{
	public MediumLevel()
	{
		super(1, R.drawable.yellow, R.string.level2_short, R.string.level2_long);
	}
	...
	public GameState createNewGame() 
	{
		...
		int target = createSolvableGame(numbers, 19, 60);
